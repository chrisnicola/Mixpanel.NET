...
namespace Mixpanel.NET.Engage
{
    public class MixpanelEngage : MixpanelClientBase, IEngage
    {
        ...
        private bool Engage(string distinctId, IDictionary<string, object> setProperties = null, IDictionary<string, object> incrementProperties = null)
        {
            ...
            if((setProperties == null && incrementProperties == null) 
                || (setProperties != null && incrementProperties != null))
            {
